(function () {
    ...
    ui.Pages.define("/pages/itemDetail/itemDetail.html", {
        ...
        ready: function (element, options) {
            ...
            //001 //element.querySelector(".content").focus();

            appbar.winControl.disabled = false;
            appbar.winControl.hideCommands([labelSizeZoomIn, labelSizeZoomOut, markItem]);
            appbar.winControl.showCommands([textSizeZoomIn, textSizeZoomOut]);
